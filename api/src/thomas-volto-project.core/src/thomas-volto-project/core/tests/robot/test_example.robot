...
#
#  $ bin/test -s thomas-volto-project.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src thomas-volto-project.core.testing.Thomas-volto-project_core_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/thomas-volto-project/core/tests/robot/test_example.robot
#
