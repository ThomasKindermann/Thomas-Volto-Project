...
#
#  $ bin/test -s tvproject.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src tvproject.core.testing.Tvproject_core_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/tvproject/core/tests/robot/test_example.robot
#
